...
@interface PeripheraViewController ()<
...
- (IBAction)QDButton:(UIButton *)sender;

- (IBAction)GXButton:(UIButton *)sender;
@end

@implementation PeripheraViewController
